...
export class JuegosComponent {
  ...
  public juegos: Array<any> = [
    ...
    { name: "3 en raya",descripcion: "El juego 3 en raya", img: "https://i0.wp.com/helenecolinet.com/wp-content/uploads/2017/04/3-en-raya.png?fit=300%2C300&ssl=1", href: "juegos"},
  ];
